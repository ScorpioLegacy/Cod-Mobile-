          ...
          <div class="col-md-6">
            <div class="thumbnail">
              <a href="/w3images/lights.jpg">
                <img src="Assets/ak47.jpg" alt="Lights" style="width:100%">
                   <div class="middle">
                     <div class="txt">AK-47</div>
                   </div>
              </a>
            </div>
          </div>
          <div class="col-md-6">
            <div class="thumbnail">
              <a href="/w3images/nature.jpg">
                <img src="Assets/asm10.jpg" alt="Nature" style="width:100%">
                   <div class="middle">
                    <div class="txt">ASM 10</div>
                   </div>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="thumbnail">
              <a href="/w3images/fjords.jpg">
                <img src="Assets/bk57.jpg" alt="Fjords" style="width:100%">                
                   <div class="middle">
                    <div class="txt">BK57</div>
                   </div>
              </a>
            </div>
          </div>
