          ...
          <div class="col-md-6">
            <div class="thumbnail">
              <a href="/w3images/lights.jpg">
                <img src="Assets/s36.jpg" alt="Lights" style="width:100%">
                   <div class="middle">
                     <div class="txt">S36</div>
                   </div>
              </a>
            </div>
          </div>
          <div class="col-md-6">
            <div class="thumbnail">
              <a href="/w3images/nature.jpg">
                <img src="Assets/m4lmg.jpg" alt="Nature" style="width:100%">
                   <div class="middle">
                    <div class="txt">M4 LMG</div>
                   </div>
              </a>
            </div>
          </div>
          ...
          <div class="col-md-6">
            <div class="thumbnail">
              <a href="/w3images/fjords.jpg">
                <img src="Assets/rpd.jpg" alt="Fjords" style="width:100%">                
                   <div class="middle">
                    <div class="txt">RPD</div>
                   </div>
              </a>
            </div>
          </div>
